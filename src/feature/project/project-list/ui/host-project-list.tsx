...
import ProjectItem from "@/feature/project/project-item/ui/project-item.tsx"
import { useToast } from "@/shared/components/toast-context.tsx"
import { updateProjectStatus } from "../../../../entities/project/api/project-api.ts"
...
export const HostProjectList = ({ searchQuery }: HostProjectListProps) => {
  ...
  const handleToggle = async (id: number) => {
    ...
    try {
      ...
      addToast({
        type: "error",
        title: "Failed to update hooks status",
        duration: 3000,
      })
    }
  }
