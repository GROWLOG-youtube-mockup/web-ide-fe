...
import { emailSchema, verificationCodeSchema } from "@/feature/user/lib/auth-schemas.ts"
import { useToast } from "@/shared/components/toast-context.tsx"
import { DEFAULT_EMAIL_VERIFY, VALIDATION } from "@/shared/constants/auth.ts"
import type {
  EmailVerificationState,
  UseEmailVerificationProps,
  UseEmailVerificationReturn,
} from "@/shared/types/auth.ts"
import { sendEmailVerification, verifyEmail } from "../../../../entities/user/api/auth-api.ts"
