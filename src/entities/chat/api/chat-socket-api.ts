...
import { getChatApiConfig } from "@/entities/chat/api/chat-api.config.ts"
import type { ChatSocketClient } from "@/entities/chat/api/chat-service.ts"
import type { SocketClient, SocketClientOptions } from "@/shared/types/chat.ts"
import { SocketConnectionError, SocketConnectionState } from "@/shared/types/chat.ts"
