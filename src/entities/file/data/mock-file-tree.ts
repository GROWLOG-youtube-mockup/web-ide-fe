      ...
      children: [
        {
          children: [
              ...
              children: [
                {
                  children: [
                    {
                      path: "/src/ui/ide/code-editor.tsx",
                      type: "file",
                    },
                    {
                      path: "/src/ui/ide/ResizeHandle.tsx",
                      type: "file",
                    },
                    { path: "/src/ui/ide/top-bar.tsx", type: "file" },
                    {
                      children: [
                        {
                          path: "/src/ui/ide/sidebar/ActionButton.tsx",
                          type: "file",
                        },
                        {
                          path: "/src/ui/ide/sidebar/AppSidebar.tsx",
                          type: "file",
                        },
                        {
                          path: "/src/ui/ide/sidebar/FileExplorer.tsx",
                          type: "file",
                        },
                        {
                          path: "/src/ui/ide/sidebar/FileTree.tsx",
                          type: "file",
                        },
                        {
                          path: "/src/ui/ide/sidebar/NavigationPanel.tsx",
                          type: "file",
                        },
                        {
                          path: "/src/ui/ide/sidebar/ViewManager.tsx",
                          type: "file",
                        },
                      ],
                      path: "/src/ui/ide/sidebar",
                      type: "folder",
                    },
                  ],
                  path: "/src/ui/ide",
                ...
                {
                  children: [
                    { path: "/src/ui/ui/Button.tsx", type: "file" },
                    { path: "/src/ui/ui/Input.tsx", type: "file" },
                    {
                      path: "/src/ui/ui/collapsible.tsx",
                      type: "file",
                    },
                    { path: "/src/ui/ui/separator.tsx", type: "file" },
                    { path: "/src/ui/ui/sheet.tsx", type: "file" },
                    { path: "/src/ui/ui/sidebar.tsx", type: "file" },
                    { path: "/src/ui/ui/skeleton.tsx", type: "file" },
                    { path: "/src/ui/ui/tooltip.tsx", type: "file" },
                  ],
                  path: "/src/ui/ui",
                  type: "folder",
                },
            ...
            {
              children: [
                { path: "/src/pages/Layout.tsx", type: "file" },
                { path: "/src/pages/Error.tsx", type: "file" },
                { path: "/src/pages/Layout.tsx", type: "file" },
                { path: "/src/pages/page.tsx", type: "file" },
                { path: "/src/pages/Page.tsx", type: "file" },
                { path: "/src/pages/page.tsx", type: "file" },
              ],
              path: "/src/pages",
            ...
            {
              children: [
                { path: "/src/lib/link-message-parser.ts", type: "file" },
            ...
            {
              children: [{ path: "/src/routes/index.tsx", type: "file" }],
              path: "/src/routes",
              type: "folder",
            },
            {
